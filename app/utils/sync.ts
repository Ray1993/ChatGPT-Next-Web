import { ChatSession, useAccessStore, useAppConfig, useChatStore } from '../store';
 ...
 */
export function mergeWithUpdate<T extends { lastUpdateTime?: number }>(localState: T, remoteState: T) {
