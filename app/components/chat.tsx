...
import { copyToClipboard, selectOrCopy, autoGrowTextArea, useMobileScreen } from '../utils';
...
export function ChatActions(props: {
    ...
    return (
        <div className={styles['chat-input-actions']}>
            ...
            <ChatAction onClick={() => setShowModelSelector(true)} text={currentModel} icon={<RobotIcon />} />
...
function _Chat() {
    ...
    const isAdmin = useLoginStore.getState().getPermission() === '1';
        ...
        <div className={styles.chat} key={session.id}>
            <div className="window-header" data-tauri-drag-region>
                ...
                <div className="window-actions">
                    {!isMobileScreen && (
                        <div className="window-action-button">
                            <IconButton icon={<RenameIcon />} bordered onClick={() => setIsEditingMessage(true)} />
                        </div>
                    )}
                    <div className="window-action-button">
                        <IconButton
                    ...
                    <div className="window-action-button window-action-button-close">
                        <button
                            onClick={async () => {
                                const isLogout = await useLoginStore.getState().logout();
                                if (isLogout) {
                                    navigate(Path.Login);
                                }
                            }}
