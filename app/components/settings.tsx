...
import { Input, List, ListItem, Modal, PasswordInput, Popover, Select, showConfirm, showToast } from './ui-lib';
import { ModelConfigList } from './model-config';

import { IconButton } from './button';
import { SubmitKey, useChatStore, Theme, useUpdateStore, useAccessStore, useAppConfig, useLoginStore } from '../store';
            ...
            >
                <div className={styles['edit-prompt-modal']}>
                    ...
                    <Input
                        ...
                        rows={10}
                        onInput={(e) =>
                            promptStore.updatePrompt(props.id, (prompt) => (prompt.content = e.currentTarget.value))
                        }
                    ></Input>
                </div>
            </Modal>
                                        ...
                                        {accessStore.provider === 'OpenAI' ? (
                                            ...
                                            <>
                                                ...
                                                <ListItem
                                                    ...
                                                    subTitle={Locale.Settings.Access.Google.ApiVerion.SubTitle}
                                                >
                                                    <input
                                                        type="text"
