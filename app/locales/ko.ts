...
const ko: PartialLocaleType = {
    ...
    Settings: {
        ...
        Prompt: {
            ...
            List: '프롬프트 목록',
            ListCount: (builtin: number, custom: number) => `내장 ${builtin}개, 사용자 정의 ${custom}개`,
            Edit: '편집',
            Modal: {
                Title: '프롬프트 목록',
                Add: '추가',
    ...
    Store: {
        ...
        Prompt: {
            History: (content: string) => '이것은 AI와 사용자 간의 대화 기록을 요약한 내용입니다: ' + content,
    ...
    Mask: {
        ...
        EditModal: {
            Title: (readonly: boolean) => `프롬프트 템플릿 편집 ${readonly ? '(읽기 전용)' : ''}`,
            Download: '다운로드',
            Clone: '복제',
        },
        Config: {
