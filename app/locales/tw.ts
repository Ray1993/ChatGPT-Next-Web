...
const tw: PartialLocaleType = {
    ...
    Settings: {
        ...
        Prompt: {
            ...
            List: '自定義提示詞列表',
            ListCount: (builtin: number, custom: number) => `內建 ${builtin} 條，使用者定義 ${custom} 條`,
            Edit: '編輯',
            Modal: {
                Title: '提示詞列表',
                Add: '新增一條',
    ...
    Store: {
        ...
        Error: '出錯了，請稍後再嘗試',
        Prompt: {
            History: (content: string) => '這是 AI 與使用者的歷史聊天總結，作為前情提要：' + content,
    ...
    Mask: {
        ...
        EditModal: {
            Title: (readonly: boolean) => `編輯預設面具 ${readonly ? '（只讀）' : ''}`,
            Download: '下載預設',
            Clone: '複製預設',
        },
        Config: {
