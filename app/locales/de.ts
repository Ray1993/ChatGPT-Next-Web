...
const de: PartialLocaleType = {
    ...
    Settings: {
        ...
        PresencePenalty: {
            ...
            SubTitle: 'Ein größerer Wert erhöht die Wahrscheinlichkeit, dass über neue Themen gesprochen wird',
        },
        FrequencyPenalty: {
            Title: 'Frequency Penalty', // HäufigkeitStrafe
            SubTitle: 'Ein größerer Wert, der die Wahrscheinlichkeit verringert, dass dieselbe Zeile wiederholt wird',
        },
    },
    Store: {
