...
const it: PartialLocaleType = {
    ...
    Settings: {
        ...
        CompressThreshold: {
            ...
            SubTitle: 'Comprimerà se la lunghezza dei messaggi non compressi supera il valore',
        },
        ...
        PresencePenalty: {
            ...
            SubTitle: 'Un valore maggiore aumenta la probabilità di parlare di nuovi argomenti',
        },
        FrequencyPenalty: {
            Title: 'Penalità di frequenza',
            SubTitle: 'Un valore maggiore che diminuisce la probabilità di ripetere la stessa riga',
        },
    },
    Store: {
        ...
        Prompt: {
            History: (content: string) =>
                "Questo è un riassunto della cronologia delle chat tra l'IA e l'utente:" + content,
