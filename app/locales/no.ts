...
const no: PartialLocaleType = {
    ...
    Memory: {
        ...
        ResetConfirm: 'Om du nillstiller vil du slette hele historikken. Er du sikker på at du vil nullstille?',
    },
    Home: {
        NewChat: 'Ny chat',
    ...
    Settings: {
        ...
        Prompt: {
            ...
            List: 'Instruksliste',
            ListCount: (builtin: number, custom: number) => `${builtin} innebygde, ${custom} brukerdefinerte`,
            Edit: 'Endre',
            Modal: {
                Title: 'Instruksliste',
                Add: 'Legg til',
        ...
        CompressThreshold: {
            ...
            SubTitle: 'Komprimer dersom ikke-komprimert lengde på meldinger overskrider denne verdien',
        },
    ...
    Store: {
        ...
        Prompt: {
            History: (content: string) =>
                'Dette er et sammendrag av chatthistorikken mellom AI-en og brukeren som en oppsummering: ' + content,
            Topic: 'Vennligst lag en fire til fem ords tittel som oppsummerer samtalen vår uten innledning, punktsetting, anførselstegn, punktum, symboler eller tillegg tekst. Fjern innrammende anførselstegn.',
            Summarize:
