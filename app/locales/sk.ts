...
const sk: PartialLocaleType = {
    ...
    Settings: {
        ...
        Prompt: {
            ...
            List: 'Zoznam výziev',
            ListCount: (builtin: number, custom: number) => `${builtin} vstavaných, ${custom} užívateľsky definovaných`,
            Edit: 'Upraviť',
            Modal: {
                Title: 'Zoznam výziev',
                Add: 'Pridať jednu',
    ...
    Store: {
        ...
        Prompt: {
            History: (content: string) => 'Toto je zhrnutie histórie chatu ako rekapitulácia: ' + content,
            Topic: 'Prosím, vygenerujte štvor- až päťslovný titul, ktorý zhrnie našu konverzáciu bez akéhokoľvek úvodu, interpunkcie, úvodzoviek, bodiek, symbolov, tučného textu alebo ďalšieho textu. Odstráňte uzatváracie úvodzovky.',
            Summarize:
