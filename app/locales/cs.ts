...
const cs: PartialLocaleType = {
    WIP: 'V přípravě...',
    Error: {
        Unauthorized: 'Neoprávněný přístup, zadejte přístupový kód na [stránce](/#/auth) nastavení.',
    },
    ChatItem: {
    ...
    Settings: {
        ...
        Prompt: {
            ...
            List: 'Seznam pokynů',
            ListCount: (builtin: number, custom: number) => `${builtin} vestavěných, ${custom} uživatelských`,
            Edit: 'Upravit',
            Modal: {
                Title: 'Seznam pokynů',
                Add: 'Přidat pokyn',
        ...
        CompressThreshold: {
            ...
            SubTitle: 'Komprese proběhne, pokud délka nekomprimovaných zpráv přesáhne tuto hodnotu',
        },
        ...
        FrequencyPenalty: {
            ...
            SubTitle: 'Větší hodnota snižující pravděpodobnost opakování stejného řádku',
        },
    },
    Store: {
        ...
        Prompt: {
            History: (content: string) =>
                'Toto je shrnutí historie chatu mezi umělou inteligencí a uživatelem v podobě rekapitulace: ' + content,
            Topic: 'Vytvořte prosím název o čtyřech až pěti slovech vystihující průběh našeho rozhovoru bez jakýchkoli úvodních slov, interpunkčních znamének, uvozovek, teček, symbolů nebo dalšího textu. Odstraňte uvozovky.',
            Summarize: 'Krátce shrň naši diskusi v rozsahu do 200 slov a použij ji jako podnět pro budoucí kontext.',
        },
    },
    Copy: {
    ...
    Mask: {
        ...
        EditModal: {
            Title: (readonly: boolean) => `Editovat šablonu pokynu ${readonly ? '(pouze ke čtení)' : ''}`,
            Download: 'Stáhnout',
            Clone: 'Duplikovat',
        },
        Config: {
