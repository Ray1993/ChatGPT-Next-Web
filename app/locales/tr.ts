...
const tr: PartialLocaleType = {
    ...
    Error: {
        Unauthorized: 'Yetkisiz erişim, lütfen erişim kodunu ayarlar [sayfasından](/#/auth) giriniz.',
    },
    ChatItem: {
    ...
    Settings: {
        ...
        InjectSystemPrompts: {
            ...
            SubTitle: 'Her istek için ileti listesinin başına simüle edilmiş bir ChatGPT sistem ipucu ekleyin',
        },
        Update: {
        ...
        Prompt: {
            ...
            List: 'Komut Listesi',
            ListCount: (builtin: number, custom: number) => `${builtin} yerleşik, ${custom} kullanıcı tanımlı`,
            Edit: 'Düzenle',
            Modal: {
                Title: 'Prompt List',
                Add: 'Add One',
        ...
        PresencePenalty: {
            Title: 'Varlık Cezası',
            SubTitle: 'Daha büyük bir değer, yeni konular hakkında konuşma olasılığını artırır',
        },
        FrequencyPenalty: {
            Title: 'Frekans Cezası',
            SubTitle: 'Aynı satırı tekrar etme olasılığını azaltan daha büyük bir değer',
        },
    },
    Store: {
        ...
        Prompt: {
            History: (content: string) =>
                'Bu, yapay zeka ile kullanıcı arasındaki sohbet geçmişinin bir özetidir: ' + content,
            Topic: 'Lütfen herhangi bir giriş, noktalama işareti, tırnak işareti, nokta, sembol veya ek metin olmadan konuşmamızı özetleyen dört ila beş kelimelik bir başlık oluşturun. Çevreleyen tırnak işaretlerini kaldırın.',
            Summarize:
