...
const pt: PartialLocaleType = {
    ...
    Settings: {
        ...
        Prompt: {
            ...
            ListCount: (builtin: number, custom: number) => `${builtin} embutidos, ${custom} definidos pelo usuário`,
            Edit: 'Editar',
            Modal: {
    ...
    Store: {
        ...
        Prompt: {
            History: (content: string) => 'Este é um resumo do histórico de chat como um recapitulativo: ' + content,
            Topic: 'Por favor, gere um título de quatro a cinco palavras resumindo nossa conversa sem qualquer introdução, pontuação, aspas, períodos, símbolos ou texto adicional. Remova as aspas que o envolvem.',
            Summarize:
    ...
    Mask: {
        ...
        EditModal: {
            Title: (readonly: boolean) => `Editar Template de Prompt ${readonly ? '(somente leitura)' : ''}`,
            Download: 'Baixar',
            Clone: 'Clonar',
        },
        Config: {
