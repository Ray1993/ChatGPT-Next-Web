...
const es: PartialLocaleType = {
    ...
    Settings: {
        ...
        Prompt: {
            ...
            ListCount: (builtin: number, custom: number) => `${builtin} incorporado, ${custom} definido por el usuario`,
            Edit: 'Editar',
            Modal: {
                Title: 'Prompt List',
                Add: 'Add One',
        ...
        CompressThreshold: {
            ...
            SubTitle: 'Se comprimirán los mensajes si la longitud de los mensajes no comprimidos supera el valor',
        },
        ...
        FrequencyPenalty: {
            ...
            SubTitle: 'Un valor mayor que disminuye la probabilidad de repetir la misma línea',
        },
    },
    Store: {
        ...
        Prompt: {
            History: (content: string) =>
                'Este es un resumen del historial del chat entre la IA y el usuario como recapitulación: ' + content,
            Topic: 'Por favor, genera un título de cuatro a cinco palabras que resuma nuestra conversación sin ningún inicio, puntuación, comillas, puntos, símbolos o texto adicional. Elimina las comillas que lo envuelven.',
            Summarize:
