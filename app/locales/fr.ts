...
const fr: PartialLocaleType = {
    ...
    Store: {
        ...
        Prompt: {
            History: (content: string) =>
                "Ceci est un résumé de l'historique des discussions entre l'IA et l'utilisateur : " + content,
            Topic: 'Veuillez générer un titre de quatre à cinq mots résumant notre conversation sans introduction, ponctuation, guillemets, points, symboles ou texte supplémentaire. Supprimez les guillemets inclus.',
            Summarize:
    ...
    Mask: {
        ...
        EditModal: {
            Title: (readonly: boolean) => `Modifier le modèle de prompt ${readonly ? '(en lecture seule)' : ''}`,
            Download: 'Télécharger',
            Clone: 'Dupliquer',
        },
        Config: {
