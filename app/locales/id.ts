...
const id: PartialLocaleType = {
    ...
    Settings: {
        ...
        Prompt: {
            ...
            List: 'Daftar Prompt',
            ListCount: (builtin: number, custom: number) => `${builtin} bawaan, ${custom} penggunaan khusus`,
            Edit: 'Edit',
            Modal: {
                Title: 'Daftar Prompt',
                Add: 'Tambahkan',
    ...
    Store: {
        ...
        Prompt: {
            History: (content: string) => 'Ini adalah ringkasan singkat dari riwayat percakapan: ' + content,
    ...
    Mask: {
        ...
        EditModal: {
            Title: (readonly: boolean) => `Edit Template Prompt ${readonly ? '(hanya baca)' : ''}`,
            Download: 'Unduh',
            Clone: 'Duplikat',
        },
        Config: {
